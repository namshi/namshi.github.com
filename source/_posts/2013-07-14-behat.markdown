...
{% img center /images/gherkin.jpg 'Gherkin' 'Gherkin' %}
...
{% img center /images/execution.jpg 'Running Test Suite' 'Running Test Suite' %}

When the execution completes, we can open the tool's webpage and review the results!

{% img center /images/results.jpg 'Results on the webpage' 'Results on the webpage' %}
