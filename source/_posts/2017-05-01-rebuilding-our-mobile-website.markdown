...
{% img center /images/posts/web-mobile-demo.gif  %}


## Re-writing the styles

{% img center /images/posts/css-code.png  %}
...
The total size of the minified styles was 18kb, now it is **10kb:** almost half of our css is gone!
...
We came up with idea of a “**Shadow Product”:**  When a user taps on a product while on the catalog listing page, we delay the tap event for 10ms and we show a fake preview of what the next product page will look like. Simple and dirty, but looks great!
...
{% img center /images/posts/slim-slider.gif  %}
...
{% img center /images/posts/chunk-size.png  %}
...
{% img center /images/posts/before-preload.png  %}

**After**

{% img center /images/posts/after-preload.png  %}
...
{% img center /images/posts/web-mobile-results.png  %}
